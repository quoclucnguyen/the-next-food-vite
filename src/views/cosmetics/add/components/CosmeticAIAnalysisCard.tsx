    ...
    <Card>
      ...
      <CardContent>
        <FormField
          control={control}
          name="image_url"
          render={({ field }: { field: ControllerRenderProps<CosmeticFormValues, "image_url"> }) => (
            <FormItem>
              <FormControl>
                <ImageUpload
        ...
        {aiGeneratedInfo && (
          <div className="mt-6 space-y-4">
            ...
            <div className="space-y-2 text-sm">
              ...
              <Detail label="Dung tích/Khối lượng" value={aiGeneratedInfo.size} />
            ...
            <Alert>
              <Info className="h-4 w-4" />
              <AlertDescription>
                Các trường trên đã được AI điền sẵn. Vui lòng kiểm tra và chỉnh sửa nếu cần.
              </AlertDescription>
            </Alert>
          </div>
        )}
